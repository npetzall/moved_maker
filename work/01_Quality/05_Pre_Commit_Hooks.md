...
- [x] Copy the complete configuration from `../plan/01_Quality/PRE_COMMIT.md` (Configuration section)
...
- [x] Copy the `.config/sumi.toml` configuration from `../plan/01_Quality/PRE_COMMIT_HOOKS.md` (git-sumi Configuration section)
- [x] Review configuration options (see `../plan/01_Quality/PRE_COMMIT_HOOKS.md` for detailed explanations)
...
- [x] Document Conventional Commits format:
  ...
  - [x] Reference to `.config/sumi.toml` for complete configuration (see `../plan/01_Quality/PRE_COMMIT_HOOKS.md` - git-sumi Configuration section)
...
**Note**: The commit message format is enforced by `git-sumi` using the configuration in `.config/sumi.toml`. See the `.config/sumi.toml` configuration in `../plan/01_Quality/PRE_COMMIT_HOOKS.md` (git-sumi Configuration section) for the complete configuration.

### Type
Allowed types are configured in `.config/sumi.toml` (see `../plan/01_Quality/PRE_COMMIT_HOOKS.md`). Standard types include:
- `feat`: New feature
- `fix`: Bug fix
...
### Subject
Subject rules are enforced by `.config/sumi.toml` configuration (see `../plan/01_Quality/PRE_COMMIT_HOOKS.md` for complete configuration):
...
- Ensure type is one of the allowed types (see `.config/sumi.toml` configuration in `../plan/01_Quality/PRE_COMMIT_HOOKS.md`)
...
- Copy the `.config/sumi.toml` configuration from `../plan/01_Quality/PRE_COMMIT_HOOKS.md` (git-sumi Configuration section)
...
- [PRE_COMMIT.md](../plan/01_Quality/PRE_COMMIT.md) - Detailed pre-commit framework documentation
- [PRE_COMMIT_HOOKS.md](../plan/01_Quality/PRE_COMMIT_HOOKS.md) - Detailed hook selection and configuration
