# Implementation Plan: BUG_RELEASE_VERSION_COUNTS_NON_APPLICATION_COMMITS

**Status**: ✅ Complete

## Overview

This implementation plan addresses the bug described in `plan/25W46/BUG_RELEASE_VERSION_COUNTS_NON_APPLICATION_COMMITS.md`.

## Context

Related bug report: `plan/25W46/BUG_RELEASE_VERSION_COUNTS_NON_APPLICATION_COMMITS.md`
